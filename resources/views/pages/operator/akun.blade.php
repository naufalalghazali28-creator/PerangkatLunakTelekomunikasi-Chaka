    ...
    <div class="max-w-2xl space-y-4">
        <x-card shadow class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl">
            <div class="flex items-center gap-4 mb-6 pb-6 border-b border-zinc-100 dark:border-zinc-800">
                <div class="w-16 h-16 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-2xl font-bold text-blue-500">
        ...
        <x-card shadow class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl">
            ...
            <div class="space-y-4">
                <x-input label="Password Lama"             wire:model="currentPassword" type="password" icon="o-lock-closed" placeholder="••••••••" />
                <x-input label="Password Baru"             wire:model="newPassword"     type="password" icon="o-lock-open"   placeholder="Min. 8 karakter" />
                <x-input label="Konfirmasi Password Baru"  wire:model="confirmPassword" type="password" icon="o-check"      placeholder="••••••••" />
            </div>
            <x-slot:actions>
